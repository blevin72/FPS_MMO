...
namespace Gaia
{
    ...
    public class UserFilesEditor : PWEditor
    {
        ...
        private void DrawUserFiles(bool helpEnabled)
        {
            ...
            m_userFiles.m_scanForBiomesAfterAssetImport = m_editorUtils.Toggle("ScanForBiomesOnAssetImport", m_userFiles.m_scanForBiomesAfterAssetImport, helpEnabled);
            ...
            //Commented out for now - this button does not make sense with the newer modular structure of Gaia 2023, there is not a single directory that contains the default biomes anymore.
