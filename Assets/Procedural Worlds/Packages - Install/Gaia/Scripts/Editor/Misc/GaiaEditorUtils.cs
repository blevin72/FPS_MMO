...
namespace Gaia
{
    public static class GaiaEditorUtils
    {
        ...
        public static void SearchAndAddBiomePresets(bool newBiomesOnly = true)
        {
            ...
            {
                string popupText = "Gaia found the following new biomes in the project:\r\n\r\n";
                ...
                popupText += "Do you want to add these biomes to the Gaia Manager / World Designer? If not, you can still use those Biomes manually or decide to add them to the Gaia Manager manually later by adding them in the 'User Files' configuration object.";
