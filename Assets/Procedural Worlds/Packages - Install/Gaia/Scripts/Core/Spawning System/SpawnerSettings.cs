...
namespace Gaia
{
    ...
    public class SpawnerSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        /// </summary>
        public bool m_generateRandomSeed = false;
        ...
        /// <summary>
        /// Density of the stamp placement for the random terrain generation
        /// </summary>
        public int m_stampDensity;

        /// <summary>
        /// Jittering for the stamp positions when spawning stamps
        /// </summary>
        public float m_stampJitter = 0.25f;

        /// <summary>
        /// Multiplicator for the overall stamp width
        /// </summary>
        public int m_stampWidth = 100;

        /// <summary>
        /// Multiplicator for the overall stamp height
        /// </summary>
        public int m_stampHeight = 100;
