...
namespace Gaia
{
    ...
    public class GaiaWorldManager
    {
        ...
        {
            RenderTexture renderTexture = t.terrainData.heightmapTexture;
        ...
        {
            positionNU.x = Mathf.Max(0f,Mathf.Floor(positionNU.x + m_NUZeroOffset.x));
            positionNU.y = Mathf.Max(0f,Mathf.Floor(positionNU.y + m_NUZeroOffset.y));
            positionNU.z = Mathf.Max(0f, Mathf.Floor(positionNU.z + m_NUZeroOffset.z));
        }
