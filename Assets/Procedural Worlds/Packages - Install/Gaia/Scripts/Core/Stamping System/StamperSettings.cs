...
namespace Gaia
{
    ...
    public class StamperSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        /// <summary>
        /// The base terrain input type, only relevant if these stamper settings are used in the stamper created by the world designer
        /// </summary>
        public BaseTerrainInputType m_baseTerrainInputType;

        /// <summary>
        /// The terrain used for input in the world designer stamper
        /// </summary>
        ...
        {
            m_absoluteHeightValue = protoTerrainModifierStamp.m_absoluteHeightValue;
            m_rotation = protoTerrainModifierStamp.m_rotation;
            m_operation = protoTerrainModifierStamp.m_operation;
            m_blendStrength = protoTerrainModifierStamp.m_blendStrength;
            m_y = protoTerrainModifierStamp.m_y;
            m_height = protoTerrainModifierStamp.m_height;
            m_heightTransformCurve = new AnimationCurve(protoTerrainModifierStamp.m_heightTransformCurve.keys);
            m_contrastFeatureSize = protoTerrainModifierStamp.m_contrastFeatureSize;
            m_contrastStrength = protoTerrainModifierStamp.m_contrastStrength;
            m_terraceCount = protoTerrainModifierStamp.m_terraceCount;
            m_terraceJitterCount = protoTerrainModifierStamp.m_terraceJitterCount;
            m_terraceBevelAmountInterior = protoTerrainModifierStamp.m_terraceBevelAmountInterior;
            m_sharpenRidgesMixStrength = protoTerrainModifierStamp.m_sharpenRidgesMixStrength;
            m_sharpenRidgesIterations = protoTerrainModifierStamp.m_sharpenRidgesIterations;
            m_powerOf = protoTerrainModifierStamp.m_powerOf;
            m_smoothVerticality = protoTerrainModifierStamp.m_smoothVerticality;
            m_smoothBlurRadius = protoTerrainModifierStamp.m_smoothBlurRadius;
            m_stamperInputImageMask = ImageMask.Clone(protoTerrainModifierStamp.m_stamperInputImageMask);
            m_mixMidPoint = protoTerrainModifierStamp.m_mixMidPoint;
            m_mixHeightStrength = protoTerrainModifierStamp.m_mixHeightStrength;
    }
