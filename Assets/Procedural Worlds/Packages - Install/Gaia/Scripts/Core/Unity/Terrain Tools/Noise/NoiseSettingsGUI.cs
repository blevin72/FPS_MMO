...
namespace Gaia
{
    ...
    public class NoiseSettingsGUI
    {
        ...
        private bool m_noisePreviewIsLocked = false;
        ...
        public void OnGUI(NoiseSettingsGUIFlags flags = NoiseSettingsGUIFlags.All)
        {
            ...
            {
                DrawPreviewTexture(256f,ref m_noisePreviewIsLocked);
            }
        ...
        static class Styles
        {
            ...
            public static GUIContent buttonLocked = EditorGUIUtility.TrTextContent("Locked", "The preview texture is currently locked for changes from mouse input. Click here to unlock it.");
            public static GUIContent buttonUnlocked = EditorGUIUtility.TrTextContent("Unlocked", "The preview texture is currently active for changes from mouse input. Click here to lock it.");
