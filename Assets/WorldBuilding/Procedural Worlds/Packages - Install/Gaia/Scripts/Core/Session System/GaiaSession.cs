...
namespace Gaia
{
    ...
    //    {
    //        return PWCommon5.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(m_fileName);
    //    }
    ...
    //    {
    //        return PWCommon5.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(soFileName);
    //    }
    ...
    public class GaiaSession : ScriptableObject
    {
        ...
        {
            return PWCommon5.Utils.FixFileName(m_name);
        }
