...
namespace Gaia
{
    ...
    public class NoiseSettings : ScriptableObject
    {
        ...
        public struct NoiseDomainSettings
        {
            ...
            {
#if UNITY_EDITOR
                noiseTypeName = Gaia.PerlinNoise.instance.GetDescription().name;
                fractalTypeName = Gaia.FbmFractalType.instance.GetDescription().name;
                noiseTypeParams = Gaia.PerlinNoise.instance.GetDefaultSerializedString();
                fractalTypeParams = Gaia.FbmFractalType.instance.GetDefaultSerializedString();
#endif
            }
        }
