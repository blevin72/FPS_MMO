...
//            if (Gaia.TerrainHelper.GetActiveTerrain() != null)
//            {
//                //Get sea level
...
//            m_visualiser.m_spawner.m_settings.m_resources = m_visualiser.m_resources;
//            m_visualiser.m_spawner.m_spawnCollisionLayers = m_visualiser.m_fitnessCollisionLayers;
//            m_visualiser.m_spawner.m_settings.m_spawnRange = m_visualiser.m_range;
...
//                            m_visualiser.m_lastHitTerrainRelativeHeight = m_visualiser.m_lastHitTerrainHeight - GaiaSessionManager.GetSessionManager(false).GetSeaLevel();
